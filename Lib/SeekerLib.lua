...
--Feather Icons
--[[Criado por 7kayoh]-- https://github.com/evoincorp/lucideblox/tree/master/src/modules/util
local Icons = {}
...
if not Success then
	warn("\n Orion Library - Falha ao carregar Feather Icons. Código de erro: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("[ Seeker Library ] Config Loader - Não foi possível encontrar ", a ,b)
		end
	end)
end
		...
		pcall(function()
			if isfile(OrionLib.Folder .. "/" .. game.GameId .. ".txt") then
				...
				OrionLib:MakeNotification({
					Name = "Configuração - Seeker Library",
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Seeker Library"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		UIHidden = true
		OrionLib:MakeNotification({
			Name = "Seeker Library - Interface Oculta",
			Content = "Toque no Controle Esquerdo para reabrir a interface.",
			Time = 5
		})
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				ToggleConfig.Name = ToggleConfig.Name or "Alternar"
